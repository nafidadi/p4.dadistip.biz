	...
	<form name='register' id='register' method='POST' action='/users/p_signup'>
		<fieldset>
			...
			<label for='nick_name'>Nick Name:</label><br />
                	<input type='text' name='nick_name' id='nick_name' value='anonymous'><br /><br />
    		
    			<label for='time_zone'>Select Your Time Zone:</label><br />
    			...
    			<input type='email' name='email' id='e-mail' value='' required><br /><br />

	    		<label for='pwd'>Password:</label><br />
    			<input type='password' name='password' id='pwd' value='' required><br /><br />
